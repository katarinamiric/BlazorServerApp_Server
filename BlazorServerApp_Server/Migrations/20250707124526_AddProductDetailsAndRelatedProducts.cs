...
{
    /// <inheritdoc />
    public partial class AddProductDetailsAndRelatedProducts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LongFeatureList = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductRelatedProducts", x => new { x.ProductId, x.RelatedProductId });
                    table.ForeignKey(
